...
public interface OrderItemDAO {
        List<OrderItemDTO> getOrderItemList(String order_id) throws SQLException, ProductNotFoundException, InsufficientProductException, StockNotPresentForExistingProductException;
}
