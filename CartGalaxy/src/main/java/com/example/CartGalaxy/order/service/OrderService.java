...
public interface OrderService {
    ...
    OrderDetailDTO getOrder(String order_id) throws SQLException, ProductNotFoundException;
    OrderDetailDTO createOrder(CreateOrderDTO orderDTO) throws SQLException, ProductNotFoundException;
}
